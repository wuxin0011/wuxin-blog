...
<div class="app-container">
    <MySearchHeader :showPre="false" :showSlot="true" :show-search-input="false" @handleSearch="handleFilter" :show-search-button="false" :show-create-button="false">
        <el-button class="m-margin-left-mini" :type="compontentName === 'UploadImageTable'?'info':'success'" size="small" @click="compontentName === 'UploadImageTable' ?changeName('UploadImageList'):changeName('UploadImageTable')">
