        ...
        <el-row :gutter="10">
            ...
            <el-col :span="7" :xs="24">
                <el-form-item prop="username">
                    <el-input style="width:100%;" placeholder="昵称..." prefix-icon="el-icon-s-custom" v-model="commentUser.username" />
                </el-form-item>
            </el-col>
            <el-col :span="7" :xs="24">
                <el-form-item prop="email">
                    <el-input style="width:100%;" placeholder="邮箱..." prefix-icon="el-icon-message" v-model="commentUser.email" />
                </el-form-item>
            </el-col>
            <el-col :span="6" :xs="24">
                <el-row>
                    <el-col :span="6" :xs="24">
                        <el-button type="primary" size="small" @click.prevent="submit" :loading="submitLoading">{{ submitLoading ? '' : '提交' }} </el-button>
                    </el-col>
                    <el-col :lg="0" :md="0" :xs="12">
                        <el-popover placement="bottom" trigger="click">
                            <!-- 表情组件 -->
                            <VEmojiV2 @select="addEmoji" :emojiSize="26" direction="bottom" :emojisByRow="8" :showSearch="false" style="width:250px;height:200px;" />
                            <!-- 滑稽表情 -->
                    ...
                    <el-col :span="12" :xs="12">
                        <el-tooltip content="开启订阅通知,可收到回复消息😀" :disabled="commentUser.subscription" effect="light">
                            <el-switch v-model="commentUser.subscription" active-text="订阅" size="small"></el-switch>
                        </el-tooltip>
                    </el-col>
                </el-row>
