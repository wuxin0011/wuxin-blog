...
<div class="ui vertical segment inverted m-flex-footer">
    <div class="ui center aligned container footer-container">
        <div class="ui inverted divided stackable grid m-text-padding-big">
            <div class="three wide computer three wide tablet sixteen wide mobile column">
                ...
                <div slot="error" class="image-slot" v-else>
                    <svg t="1638501593212" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1850" width="100" height="100">
            ...
            <div class="eight wide computer ten wide tablet sixteen wide mobile column">
                ...
                <div class="ui inverted link list" v-if="blogList && blogList.length !== 0" :class="{inverted:$store.state.setting.inverted}">
                    <router-link class="item m-text-margin-tb-small" v-for="blog in blogList" :key="blog.blogId" :to="`/blog/${blog.blogId}`">
                        {{blog.title}}
                    </router-link>
                </div>
                <div v-else>
                    <a href="javascript:void(0)" class="item m-text-margin-tb-small">暂无数据</a>
                </div>
            </div>
            <div class="five wide computer sixteen wide tablet sixteen wide mobile column m-motto-container">
                <p class="motto-content">
                    <a href="https://www.jinrishici.com" title="访问诗词来源" target="_blank">{{ content }}</a>
                </p>
        ...
        <div class="ui inverted dividing  section">
            ...
            <div v-if="labelList.length !== 0">
                <a class="ui image label" :class="lable.typeColor" :href="lable.url" :title="lable.title" v-for="(lable, index) in labelList" :key="index" target="_blank">
                    {{ lable.typeName }}
            ...
            <div v-else>
                <a class="ui image green label" href="https://vue.org.com" title="渐进式框架" target="_blank">
                    JS
