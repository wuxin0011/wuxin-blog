            ...
            <div class="ui padded attached segment m-padded-tb-large">
                ...
                <div class="ui middle aligned mobile reversed">
                    <div class="ui grid m-margin-lr">
                        ...
                        <router-link :to="`/category/${(blog.category&&blog.category)?blog.category.name:'error'}`" :class="`ui label  ${
                    blog.category&&blog.category.color ? blog.category.color : 'teal'
                  } ribbon `" style="color: white; text-decoration: none">
