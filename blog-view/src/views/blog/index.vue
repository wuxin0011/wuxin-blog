    ...
    <div>
        ...
        <div v-if="!result.secrecy || result.password === password">
            <div class="ui padded attached segment m-padded-tb-large">
                ...
                <div class="ui middle aligned mobile reversed">
                    <div class="ui grid m-margin-lr">
                        ...
                        <div class="row m-padded-tb-small">
                            <div class="ui horizontal link list m-center">
                                ...
                                <a class="item m-common-black" @click.prevent=" $store.state.setting.focusMode = !$store.state.setting.focusMode ">
                                    <div class="item m-common-black" :data-inverted="['inverted']" :data-tooltip=" $store.state.setting.focusMode ? '关闭纯净模式' : '纯净模式' " data-position="top center">
                        ...
                        <router-link 
                          :to="`/category/${ blog.category && blog.category ? blog.category.name : 'error' }`" 
                          :class="`ui label  ${ blog.category && blog.category.color ? blog.category.color : 'teal' } ribbon `" 
                          style="color: white; text-decoration: none"> {{ blog.category && blog.category ? blog.category.name : "error" }}
                        </router-link>

                        <!--文章Markdown正文-->
                        <div class=" typo m-padded-tb-small line-numbers match-braces rainbow-braces js-toc-content " :class="{ 'm-big-fontsize': bigFontSize }" v-html="blog.content" v-viewer></div>
                        <!--赞赏-->
                        ...
                        <div class="row m-padding-bottom-small">
                            <div class="column m-padding-left-no">
                                <router-link :to="`/tag/${tag.name}`" class="ui tag label m-text-500 m-margin-small" :class="tag.color ? tag.color : 'teal'" v-for="(tag, index) in blog.tags" :key="index">
                                    {{ tag.name }}
                                </router-link>
                            </div>
                        </div>
                    ...
                    <div class="thirteen wide computer sixteen wide mobile column">
                        <div class="float left">
                            <ul class="list">
                                ...
                                <li>
                                    本站点采用<a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" style="color: #000">
            ...
            <div class="ui attached segment">
                <Comment :id="$route.params.blogId" :type="1" :comment-enabled="blog.commentEnabled" />
            </div>
        </div>
            ...
            <div class="ui m-padded-tb-mini">
                <el-tooltip content="点击输入密码解锁" placement="bottom" effect="light">
                    <div class="ui inverted button" tabindex="0" @click="getData($route.params.blogId)">
                        <div class="content">
                            <svg t="1638715240373" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2330" width="150" height="150">
